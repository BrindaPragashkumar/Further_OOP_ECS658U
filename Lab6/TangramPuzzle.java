...
public class TangramPuzzle {
    ...
    public static void main(String[] args) {
        ...
        JPanel panel = new JPanel() {
            final PuzzleModel model = new PuzzleModel(TangramTiles.getBox(), TangramTiles.getTiles());
...

            {
                addMouseListener(new MouseAdapter() {
                    ...
                    public void mousePressed(MouseEvent e) {
                        currentShape =
                                model.getTileAt(pointToVec2d(e.getPoint()));
...
// moveTo is absolute, so we need to add the delta to the current position
            ...
            protected void paintComponent(Graphics g) {
                ...
                for (DrawablePolygon shape : model.tiles) {
